  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2">
        ...
        <input name="videoUrl" required type="url" defaultValue={server.videoUrl} className="bg-black/50 border border-white/10 rounded-sm px-4 py-2.5 text-eter-starlight focus:border-eter-cyan focus:outline-none transition-colors" />
      </div>
